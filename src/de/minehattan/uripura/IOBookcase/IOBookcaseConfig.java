...
public class IOBookcaseConfig {
	...
	public IOBookcaseConfig(File cFile) {
		...
		this.configDefaults.put("sql.enable", false);
		this.configDefaults.put("sql.password", "pass");
		this.configDefaults.put("sql.username", "minecraft");
		this.configDefaults.put("sql.database", "minecraft");
		this.configDefaults.put("sql.port", 3306);
		this.configDefaults.put("sql.hostname", "localhost");
